...
const assetList: Asset[] = [
  // ── 人物 ──
  {
    id: A.suke, kind: 'character', role: 'lead', skipImageGen: false,
    name: '苏可',
  ...
  {
    id: A.mom, kind: 'character', role: 'support', skipImageGen: true,
    name: '妈妈',
  ...
  {
    id: A.delivery, kind: 'character', role: 'extra', skipImageGen: true,
    name: '外卖员',
  ...
  // ── 道具（只提取会被镜头单独交代的物件）──
  {
    id: A.phone, kind: 'prop', minor: false,
    name: '智能手机',
  ...
  {
    id: A.pillow, kind: 'prop', minor: false,
    name: '沙发抱枕',
  ...
  {
    id: A.bear, kind: 'prop', minor: false,
    name: '巨大毛绒熊',
  ...
  {
    id: A.bag, kind: 'prop', minor: false,
    name: '外卖打包袋',
  ...
  {
    id: A.malatang, kind: 'prop', minor: false,
    name: '豪华麻辣烫',
  ...
  {
    id: A.napkin, kind: 'prop', minor: true,
    name: '餐巾纸与筷子',
    description: '一次性筷子和铺开的餐巾纸，次要道具，可跳过生图。',
