...
import type { Asset, AssetKind, MountKind, MountRef } from '../data/types'
                  ...
                  {g.options.map((a) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          on
                            ? removeMount(shotId, a.id)
                            : addMount(shotId, { kind: a.kind as MountKind, assetId: a.id })
                        }
                      >
